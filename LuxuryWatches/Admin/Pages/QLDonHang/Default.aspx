                                                    ...
                                                    <div class="modal-dialog modal-lg">
                                                        ...
                                                        <div class="modal-content">
                                                            <div class="modal-header bg-primary">
                                                                ...
                                                                <h4 class="modal-title">Chi tiết đơn hàng số
                                                                    <%# Eval("maDH") %>
                                                                </h4>
                                                            </div>
                                                                    ...
                                                                    <tbody>
                                                                        <asp:Repeater ID="repeaterChiTietDH" runat="server" ItemType="LuxuryWatches.Data.chiTietDH" DataSource='<%# Eval("chiTietDHs") %>'>
                                                                            <ItemTemplate>
                                                                                <tr>
                                                                                    <td>
                                                                                        <a href='<%# GetRouteUrl("chitietsp", new { masp = Eval("maSP"), bidanh = Eval("sanPham.biDanh") }) %>' target="_blank">
                                                                                            <%# Eval("sanPham.tenSP") %>
                                                                                        </a>
                                                                                    </td>
                                                                                    <td>
                                                                                    ...
                                                                                    <td>
                                                                                        <%# Eval("sanPham.giaBan","{0:#,##0}").Replace(',','.') %>
                                                                                    </td>
                                                                                    <td>
                                                                                        <%# Eval("soLuong") %>
                                                                                    </td>
